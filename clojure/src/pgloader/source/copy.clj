...
(defrecord CopySource
  ...
  (create-view! [_ _ _ _]
    (throw (UnsupportedOperationException. "create-view! not supported for COPY source")))

  (drop-view! [_ _ _]
    (throw (UnsupportedOperationException. "drop-view! not supported for COPY source")))
