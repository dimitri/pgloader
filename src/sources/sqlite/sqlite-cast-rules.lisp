...
(defparameter *sqlite-default-cast-rules*
  `((:source (:type "character") :target (:type "text" :drop-typemod t))
    ...
    ;; ORM-generated byte-array types: byte[] and bare byte both map to bytea (#1231)
    (:source (:type "byte[]") :target (:type "bytea")
             :using pgloader.transforms::byte-vector-to-bytea)
    (:source (:type "byte") :target (:type "bytea")
             :using pgloader.transforms::byte-vector-to-bytea)

    ;; PostgreSQL-style sized integer aliases used by some ORMs
    (:source (:type "int2") :target (:type "smallint")
             :using pgloader.transforms::integer-to-string)
    (:source (:type "int4") :target (:type "integer")
             :using pgloader.transforms::integer-to-string)
    (:source (:type "int8") :target (:type "bigint")
             :using pgloader.transforms::integer-to-string)
